...
echo "<TITLE>VICIDIAL: Realtime All Campagnes Summary</TITLE></HEAD><BODY BGCOLOR=WHITE marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>\n";
...
echo "<b>VICIDIAL: Realtime All Campagnes Summary</b> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; \n";
