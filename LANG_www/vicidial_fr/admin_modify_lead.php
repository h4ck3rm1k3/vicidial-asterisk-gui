...
<title>ADMINISTRATION DE VICIDIAL: Modification de l'enregistrement de la fiche</title>
</head>
<BODY BGCOLOR=white marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>
<CENTER><FONT FACE="Courier" COLOR=BLACK SIZE=3>
<? 
echo "<a href=\"./admin.php?ADD=100\">ADMINISTRATION DE VICIDIAL</a>: Modification de l'enregistrement de la fiche<BR>\n";
...
else
{
	...
	##### grab vicidial_list data for lead #####
		...
		echo "<tr><td colspan=2>Fronter: <A HREF=\"user_stats.php?user=$tsr\">$tsr</A> &nbsp; &nbsp; ID de la liste: $list_id</td></tr>\n";
		...
		echo "<tr><td align=right>Téléphone alternatif : </td><td align=left><input type=text name=alt_phone size=20 maxlength=20 value=\"$alt_phone\"></td></tr>\n";
		...
		echo "<tr><td align=right>Commentaires : </td><td align=left><TEXTAREA name=comments ROWS=3 COLS=65>$comments</TEXTAREA></td></tr>\n";
		...
		if ( ($dispo == 'CALLBK') or ($dispo == 'CBHOLD') )
		{
			...
			if ($CB_to_print>0)
				...
				if ($rowx[9] == 'USERONLY')
					...
					echo "<input type=hidden name=lead_id value=\"$lead_id\">\n";
					echo "<input type=hidden name=callback_id value=\"$rowx[0]\">\n";
					echo "New Callback Owner UtilisateurID: <input type=text name=CBuser size=8 maxlength=10 value=\"$rowx[8]\"> \n";
