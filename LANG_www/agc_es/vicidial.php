...
echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  NOWRAP><a href=\"../agc_en/vicidial.php?relogin=YES&VD_login=$VD_login&VD_campaign=$VD_campaign&phone_login=$phone_login&phone_pass=$phone_pass&VD_pass=$VD_pass\">English <img src=\"../agc/images/en.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";echo "<TD WIDTH=100 ALIGN=RIGHT VALIGN=TOP  BGCOLOR=\"#CCFFCC\" NOWRAP><a href=\"../agc_es/vicidial.php?relogin=YES&VD_login=$VD_login&VD_campaign=$VD_campaign&phone_login=$phone_login&phone_pass=$phone_pass&VD_pass=$VD_pass\">Español <img src=\"../agc/images/es.gif\" BORDER=0 HEIGHT=14 WIDTH=20></a></TD>\n";			echo "</TR></TABLE>\n";
			...
			echo "Campaña: $camp_form_code<br>\n";
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	alert(xmlhttp.responseText);
					...
					if ( (agentcallsstatus == '1') || (vicidial_agent_disable != 'NOT_ACTIVE') )
						...
						if (AGStatuS != 'N')
							{
							document.getElementById("AgentEstadoEstado").innerHTML = AGStatuS;
							}
						if (CamPCalLs != 'N')
							{
				...
				//			var live_conf_HTML = "<font face=\"Arial,Helvetica\"><B>LLAMADAS ACTIVAS EN ESTA CONFERENCIA:</B></font><BR><TABLE WIDTH=500><TR BGCOLOR=#E6E6E6><TD><font class=\"log_title\">#</TD><TD><font class=\"log_title\">CANAL REMOTO</TD><TD><font class=\"log_title\">COLGAR</TD><TD><font class=\"log_title\">TRANSFERENCIA</TD></TR>";
							var live_conf_HTML = "<font face=\"Arial,Helvetica\"><B>LLAMADAS ACTIVAS EN SU SESIÓN:</B></font><BR><TABLE WIDTH=600><TR BGCOLOR=#E6E6E6><TD><font class=\"log_title\">#</TD><TD><font class=\"log_title\">CANAL REMOTO</TD><TD><font class=\"log_title\">COLGAR</TD><TD><font class=\"log_title\">VOLUMEN</TD></TR>";
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	alert(xmlhttp.responseText);
					...
					if (MDlookCID == "NO")
						{
						MD_ring_secondS++;
						document.getElementById("MainStatuSSpan").innerHTML = " Llamando: " + lead_dial_number + " UID: " + CIDcheck + " &nbsp; Espeerar al Ring... " + MD_ring_secondS + " segundos";
				//		alert("channel not found yet:\n" + campaign);
						...
						if (taskCheckOR == 'YES')
							...
							if ( (MDchannel.match(regMDL)) && (asterisk_version != '1.0.8') && (asterisk_version != '1.0.9') )
								...
								MD_channel_look=0;
								document.getElementById("MainStatuSSpan").innerHTML = " Llamado: " + lead_dial_number + " UID: " + CIDcheck + " &nbsp;"; 
								...
								document.getElementById("InternalCloser").innerHTML = "<a href=\"#\" onclick=\"mainxfer_send_redirect('XfeRINTERNAL','" + lastcustchannel + "','" + lastcustserverip + "');return false;\"><IMG SRC=\"../agc/images/vdc_XB_internalcloser_es.gif\" border=0 alt=\"CLOSER INTERNO\"></a>";
		...
		if (xmlhttp) 
			...
			//		alert(xmlhttp.responseText);
					...
					if (MDnextCID == " LLAMADA NOT PLACED")
						...
						document.getElementById("MainStatuSSpan").innerHTML = " Llamando: " + manDiaLonly_num + " UID: " + MDnextCID + " &nbsp; Espeerar al Ring...";
...
// Send Hangup command for customer call connected to the conference now to Manager
	function dialedcall_send_hangup(dispowindow,hotkeysused,altdispo) 
		...
		//  DEACTIVATE CHANNEL-DEPENDANT BUTTONS AND VARIABLES
			...
			document.getElementById("InternalCloser").innerHTML = "<IMG SRC=\"../agc/images/vdc_XB_internalcloser_OFF_es.gif\" border=0 alt=\"CLOSER INTERNO\">";
...
// GLOBAL FUNCTIONS
	...
	function conf_channels_detail(divvar) 
		...
		if (divvar == 'SHOW')
			...
			document.getElementById("busycallsdisplay").innerHTML = "<a href=\"#\"  onclick=\"conf_channels_detail('SHOW');\">Mostrar la información del canal Conferencia</a>";
			document.getElementById("outboundcallsspan").innerHTML = '';
			LMAe[0]=''; LMAe[1]=''; LMAe[2]=''; LMAe[3]=''; LMAe[4]=''; LMAe[5]=''; 
			LMAcount=0;
			}
...
<span style="position:absolute;left:0px;top:0px;z-index:39;" id="NeWManuaLDiaLBox">
	...
	?>
	Nota: todos los nuevos plomos manuales del dial entrarán la lista 999<BR><BR>
	<table><tr>
...
<span style="position:absolute;left:5px;top:310px;z-index:21;" id="TransferMain">
	...
	<span STYLE="background-color: #CCCCCC" id="InternalCloser"><IMG SRC="../agc/images/vdc_XB_internalcloser_es.gif" border=0 alt="CLOSER INTERNO"></span>
...
<span style="position:absolute;left:0px;top:0px;z-index:29;" id="AgenTDisablEBoX">
    <table border=1 bgcolor="#FFFFFF" width=770 height=500><TR><TD align=center>Se ha inhabilitado su sesión<BR><a href="#" onclick="LogouT();return false;">SALIR</a><BR><BR><a href="#" onclick="hideDiv('AgenTDisablEBoX');return false;">Vaya Detrás</a>
</TD></TR></TABLE>
</span>
...
<span style="position:absolute;left:0px;top:0px;z-index:40;" id="PausaCodeSelectBox">
    <table border=1 bgcolor="#CCFFCC" width=770 height=460><TR><TD align=center VALIGN=top> SELECCIONE Un CÓDIGO De la PAUSA :<BR>
...
<span style="position:absolute;left:0px;top:0px;z-index:35;" id="CallBackSelectBox">
	...
	?>
	Comentarios de los CBES: <input type=text name="CallBackCommenTsField" size=50><BR><BR>
...
<tr><td align=left colspan=3>
<table><tr height=32><td height=32><font face="Arial,Helvetica" size=1>versión web client VICIDIAL: <? echo $version ?> &nbsp; &nbsp; CONSTRUCCION: <? echo $build ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Servidor: <? echo $server_ip ?>  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</font><BR>
<font class="body_small"><span id="busycallsdisplay"><a href="#"  onclick="conf_channels_detail('SHOW');">Mostrar la información del canal Conferencia</a></span></font></td><td align=right height=32>
<? if ( ($HK_statuses_camp > 0) && ( ($user_level>=$HKuser_level) or ($VU_hotkeys_active > 0) ) ) { ?>
<span id="hotkeysdisplay"><a href="#" onMouseOver="HotKeys('ON')"><IMG SRC="../agc/images/vdc_XB_hotkeysactive_OFF_es.gif" border=0 alt="TECLAS ACCESO RÁPIDO INACTIVAS"></a></span>
<? } ?>
</td></tr>
