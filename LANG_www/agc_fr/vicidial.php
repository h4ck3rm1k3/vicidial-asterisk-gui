...
$PreseT_DiaL_LinKs		= '1';	# set to 1 to show a COMPOSER link for Dial Presets
				...
				xmlhttprequestcheckauto.onreadystatechange = function() 
					...
					//		alert(xmlhttprequestcheckauto.responseText);
						...
						//	DialLog("start");
							...
							document.getElementById("MainStatuSSpan").innerHTML = " Entrant: " + status_display_number + " UID: " + CIDcheck + " &nbsp; " + VDIC_fronter; 
...
<span style="position:absolute;left:0px;top:0px;z-index:3;" id="BienvenueBoxA">
    <table border=0 bgcolor="#FFFFFF" width=<?=$CAwidth ?> height=<?=$HKwidth ?>><TR><TD align=center><BR><span id="BienvenueBoxAt">VICICOMPOSER</span></TD></TR></TABLE>
</span>
...
<span style="position:absolute;left:0px;top:0px;z-index:29;" id="AgenTDisablEBoX">
    <table border=1 bgcolor="#FFFFFF" width=<?=$CAwidth ?> height=500><TR><TD align=center>Votre session a été neutralisée<BR><a href="#" onclick="LogouT();return false;">DÉCONNEXION</a><BR><BR><a href="#" onclick="hideDiv('AgenTDisablEBoX');return false;">Retour</a>
</TD></TR></TABLE>
</span>
...
<span style="position:absolute;left:0px;top:0px;z-index:35;" id="CallBackSelectBox">
	...
	?>
	Commentaires du Rappel: <input type=text name="CallBackCommenTsField" id="CallBackCommenTsField" size=50><BR><BR>
...
<span style="position:absolute;left:154px;top:65px;z-index:17;" id="ScriptPanel">
    <table border=0 bgcolor="#FFE7D0" width=<?=$SSwidth ?> height=<?=$SSheight ?>><TR><TD align=left valign=top><font class="sb_text"><div class="scroll_script" id="ScriptContents">VICICOMPOSER SCRIPT</div></font></TD></TR></TABLE>
</span>
...
<table BGCOLOR="#E0C2D6" id="MaiNfooter" width=<?=$MNwidth ?>><tr height=32><td height=32><font face="Arial,Helvetica" size=1>VICICOMPOSER Client Web: <? echo $version ?> &nbsp; &nbsp; BUILD: <? echo $build ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Serveur: <? echo $server_ip ?>  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</font><BR>
