...
// Generate the Pause Code Chooser panel
	function PauseCodeSelectContent_create()
		...
		if ( (AutoDialWaiting == 1) || (VD_live_customer_call==1) || (alt_dial_active==1) )
			{
			alert("VOUS DEVEZ ÊTRE FAIT UNE PAUSE POUR ÉCRIRE Un CODE De PAUSE DANS LeMODE D'AUTO-COMPOSER");
			}
		else
			{
			...
			PauseCode_HTML = PauseCode_HTML + "</span></font></td></tr></table><BR><BR><font size=3 style=\"BACKGROUND-COLOR: #FFFFCC\"><b><a href=\"#\" onclick=\"PauseCodeSelect_submit('');return false;\">Retour</a>";
...
<span style="position:absolute;left:0px;top:0px;z-index:29;" id="AgenTDisablEBoX">
    <table border=1 bgcolor="#FFFFFF" width=770 height=500><TR><TD align=center>Votre session a été neutralisée<BR><a href="#" onclick="LogouT();return false;">DÉCONNEXION</a><BR><BR><a href="#" onclick="hideDiv('AgenTDisablEBoX');return false;">Retour</a>
</TD></TR></TABLE>
</span>
...
<span style="position:absolute;left:0px;top:0px;z-index:40;" id="PauseCodeSelectBox">
    <table border=1 bgcolor="#CCFFCC" width=770 height=460><TR><TD align=center VALIGN=top> CHOISISSEZ Un CODE De PAUSE :<BR>
