...
if ( (strlen($campaign)<1) || (strlen($conf_exten)<1) )
	...
	$stmt="INSERT INTO vicidial_user_log values('','$user','DÉCONNEXION','$campaign','$NOW_TIME','$StarTtime');";
	if ($DB) {echo "$stmt\n";}
	$rslt=mysql_query($stmt, $link);
...
if ($ACTION == 'updateDISPO')
{
	...
	### APPELBACK ENTRY
	if ( ($dispo_choice == 'CBHVIEUX') and (strlen($CallBackDatETimE)>10) )
		{
...
if ($ACTION == 'updateLEAD')
{
	...
	echo "Lead $lead_id l'information a été mise à jour\n";
}
