		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//			var live_conf_HTML = "<font face=\"Arial,Helvetica\"><B>ΕΝΕΡΓΕΣ ΚΛΗΣΕΙΣ ΣΕ ΑΥΤΗΝ ΤΗΝ ΔΙΑΣΚΕΨΗ:</B></font><BR><TABLE WIDTH=500><TR BGCOLOR=#E6E6E6><TD><font class=\"log_title\">#</TD><TD><font class=\"log_title\">ΑΠΟΜΑΚΡΟ ΚΑΝΑΛΙ</TD><TD><font class=\"log_title\">ΚΛΕΙΣΙΜΟ</TD><TD><font class=\"log_title\">XFER</TD></TR>";
							var live_conf_HTML = "<font face=\"Arial,Helvetica\"><B>ΕΝΕΡΓΕΣ ΚΛΗΣΕΙΣ ΣΤΗ ΣΥΝΟΔΟ ΣΑΣ:</B></font><BR><TABLE WIDTH=500><TR BGCOLOR=#E6E6E6><TD><font class=\"log_title\">#</TD><TD><font class=\"log_title\">ΑΠΟΜΑΚΡΟ ΚΑΝΑΛΙ</TD><TD><font class=\"log_title\">ΚΛΕΙΣΙΜΟ</TD></TR>";
					...
					//			live_conf_HTML = live_conf_HTML + "<tr bgcolor=\"" + row_color + "\"><td><font class=\"log_text\">" + loop_ct + "</td><td><font class=\"log_text\">" + channelfieldA + "</td><td><font class=\"log_text\"><a href=\"#\" onclick=\"livehangup_send_hangup('" + channelfieldA + "');return false;\">Hangup</td><td><font class=\"log_text\"><a href=\"#\" onclick=\"showMainXfeR('MainXfeRBox','" + channelfieldA + "');return false;\">XFER</td></tr>";
								live_conf_HTML = live_conf_HTML + "<tr bgcolor=\"" + row_color + "\"><td><font class=\"log_text\">" + loop_ct + "</td><td><font class=\"log_text\">" + channelfieldA + "</td><td><font class=\"log_text\"><a href=\"#\" onclick=\"livehangup_send_hangup('" + channelfieldA + "');return false;\">ΚΛΕΙΣΙΜΟ</td></tr>";
...
<span id="MDstatusSpan"><a href="#" onclick="NeWManuaLDiaLCalL();return false;">ΧΕΙΡ.ΚΛΗΣΗ</a></span> <BR>
</font></span>
...
<span style="position:absolute;left:0px;top:0px;z-index:37;" id="NeWManuaLDiaLBox">
	...
	<td align=left><font class="body_text"><input type=text size=24 maxlength=20 name=MDDiaLOverridE class="cust_form" value="">&nbsp; (παρακαλώ μόνο ψηφία)</td>
	</tr></table>
	<BR>
