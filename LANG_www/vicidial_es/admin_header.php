...
?>
<CENTER>
<!--<TABLE WIDTH=<?=$page_width ?> BGCOLOR=#D9E6FE cellpadding=2 cellspacing=0><TR BGCOLOR=#015B91><TD ALIGN=LEFT COLSPAN=5><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B> &nbsp; VICIDIAL ADMIN - <a href="<? echo $admin_home_url_LU ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=1>CASERO</a> | <A HREF="../agc/timeclock.php?referrer=admin"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=1>Reloj de tiempo</A> | <a href="<? echo $ADMIN ?>?force_logout=1"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=1>Salir</a></TD><TD ALIGN=RIGHT COLSPAN=6><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><? echo date("l F j, Y G:i:s A") ?> &nbsp; </B></TD></TR>

<TD ALIGN=CENTER <?=$users_hh ?>><a href="<? echo $ADMIN ?>?ADD=0"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$users_fc ?> SIZE=<?=$header_font_size ?>><?=$users_bold ?> Usuarios </a></TD>
<TD ALIGN=CENTER <?=$campaigns_hh ?>><a href="<? echo $ADMIN ?>?ADD=10"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$campaigns_fc ?> SIZE=<?=$header_font_size ?>><?=$campaigns_bold ?> Campañas </a></TD>
<?
if ($SSoutbound_autodial_active > 0)
	{
	?>
	<TD ALIGN=CENTER <?=$lists_hh ?>><a href="<? echo $ADMIN ?>?ADD=100"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$lists_fc ?> SIZE=<?=$header_font_size ?>><?=$lists_bold ?> Listas </a></TD>
	<?
	}
else
	{echo "<TD></TD>";}
?>
<TD ALIGN=CENTER <?=$scripts_hh ?>><a href="<? echo $ADMIN ?>?ADD=1000000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$scripts_fc ?> SIZE=<?=$header_font_size ?>><?=$scripts_bold ?> Escrituras </a></TD>
<?
if ($SSoutbound_autodial_active > 0)
	{
	?>
	<TD ALIGN=CENTER <?=$filters_hh ?>><a href="<? echo $ADMIN ?>?ADD=10000000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$filters_fc ?> SIZE=<?=$header_font_size ?>><?=$filters_bold ?> Filtros </a></TD>
	<?
	}
else
	{echo "<TD></TD>";}
?>
<TD ALIGN=CENTER <?=$ingroups_hh ?>><a href="<? echo $ADMIN ?>?ADD=1000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$ingroups_fc ?> SIZE=<?=$header_font_size ?>><?=$ingroups_bold ?> En-Grupos </a></TD>
<TD ALIGN=CENTER <?=$usergroups_hh ?>><a href="<? echo $ADMIN ?>?ADD=100000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$usergroups_fc ?> SIZE=<?=$header_font_size ?>><?=$usergroups_bold ?> Grupos De Usuario </a></TD>
<TD ALIGN=CENTER <?=$remoteagent_hh ?>><a href="<? echo $ADMIN ?>?ADD=10000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$remoteagent_fc ?> SIZE=<?=$header_font_size ?>><?=$remoteagent_bold ?> Agentes Alejados </a></TD>
...
<TD ALIGN=CENTER <?=$reports_hh ?>><a href="<? echo $ADMIN ?>?ADD=999999"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$reports_fc ?> SIZE=<?=$header_font_size ?>><?=$reports_bold ?> Informes </a></TD>
</TR>

<? if (strlen($users_hh) > 1) { 
	?>
<TR BGCOLOR=<?=$users_color ?>><TD ALIGN=LEFT COLSPAN=10><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> &nbsp; <a href="<? echo $ADMIN ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Demuestre A Usuarios </a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=1"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Agregue A Nuevo Usuario </a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=1A"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Usuario Del Copiar</a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=550"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Búsqueda Para Un Usuario </a> &nbsp; | &nbsp; <a href="./user_stats.php?user=<?=$user ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Estadísticas de usuario </a> &nbsp; | &nbsp; <a href="./user_status.php?user=<?=$user ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Condición de Usuario </a> &nbsp; | &nbsp; <a href="./AST_agent_time_sheet.php?agent=<?=$user ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>>Hoja de tiempo</a> </TD></TR>
<? } 
...
<TD ALIGN=CENTER <?=$list_sh ?> COLSPAN=2><a href="<? echo $ADMIN ?>?ADD=10"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$list_fc ?> SIZE=<?=$subcamp_font_size ?>>Campañas Principales</a></TD>
<TD ALIGN=LEFT <?=$status_sh ?> COLSPAN=1><a href="<? echo $ADMIN ?>?ADD=32"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$status_fc ?> SIZE=<?=$subcamp_font_size ?>> Estados </a></TD>
<TD ALIGN=LEFT <?=$hotkey_sh ?> COLSPAN=1><a href="<? echo $ADMIN ?>?ADD=33"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$hotkey_fc ?> SIZE=<?=$subcamp_font_size ?>> Teclas rápidas </a></TD>
<?
if ($SSoutbound_autodial_active > 0)
	{
	?>
	<TD ALIGN=LEFT <?=$recycle_sh ?> COLSPAN=2><a href="<? echo $ADMIN ?>?ADD=35"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$recycle_fc ?> SIZE=<?=$subcamp_font_size ?>>El Plomo Recicla</a></TD>
	<TD ALIGN=LEFT <?=$autoalt_sh ?> COLSPAN=1><a href="<? echo $ADMIN ?>?ADD=36"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$autoalt_fc ?> SIZE=<?=$subcamp_font_size ?>>Dial Automo'vil-Auto-Alt</a></TD>
	<TD ALIGN=LEFT <?=$listmix_sh ?> COLSPAN=2><a href="<? echo $ADMIN ?>?ADD=39"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$listmix_fc ?> SIZE=<?=$subcamp_font_size ?>>Mezcla De la Lista</a></TD>
	<?
	}
else
	{echo "<TD></TD>";}
?>
<TD ALIGN=LEFT <?=$pause_sh ?> COLSPAN=1><a href="<? echo $ADMIN ?>?ADD=37"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$pause_fc ?> SIZE=<?=$subcamp_font_size ?>>Códigos De la Pausa</a></TD>
<?
...
<TD ALIGN=LEFT <?=$times_sh ?> COLSPAN=2><a href="<? echo $ADMIN ?>?ADD=100000000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$times_fc ?> SIZE=<?=$header_font_size ?>> Tiempos De la Llamada </a></TD>
<TD ALIGN=LEFT <?=$phones_sh ?> COLSPAN=2><a href="<? echo $ADMIN ?>?ADD=10000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$phones_fc ?> SIZE=<?=$header_font_size ?>> Teléfonos </a></TD>
...
<TD ALIGN=LEFT <?=$server_sh ?> COLSPAN=1><a href="<? echo $ADMIN ?>?ADD=100000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$server_fc ?> SIZE=<?=$header_font_size ?>> Servidores </a></TD>
<TD ALIGN=LEFT <?=$settings_sh ?> COLSPAN=1><a href="<? echo $ADMIN ?>?ADD=311111111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$settings_fc ?> SIZE=<?=$header_font_size ?>> Ajustes Del Sistema </a></TD>
<TD ALIGN=LEFT <?=$status_sh ?> COLSPAN=2><a href="<? echo $ADMIN ?>?ADD=321111111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$status_fc ?> SIZE=<?=$header_font_size ?>>Estados De Sistema</a></TD>
</TR>
	<?
	if (strlen($times_sh) > 1) { 
		?>
	<TR BGCOLOR=<?=$times_color ?>><TD ALIGN=LEFT COLSPAN=10><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>><a href="<? echo $ADMIN ?>?ADD=100000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Demuestre Los Tiempos De la Llamada </a> &nbsp;| <a href="<? echo $ADMIN ?>?ADD=111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Agregue Un Nuevo Rato De la Llamada </a> &nbsp;| <a href="<? echo $ADMIN ?>?ADD=1000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Demuestre Los Tiempos De la Llamada Del Estado </a> &nbsp;| <a href="<? echo $ADMIN ?>?ADD=1111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Agregue Un Nuevo Rato De la Llamada Del Estado </a> &nbsp;| <a href="<? echo $ADMIN ?>?ADD=130000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Mostrar cambios </a> &nbsp;| <a href="<? echo $ADMIN ?>?ADD=131111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Añadir un nuevo cambio </a></TD></TR>
		<? } 
	if (strlen($phones_sh) > 1) { 
		?>
	<TR BGCOLOR=<?=$phones_color ?>><TD ALIGN=LEFT COLSPAN=10><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> &nbsp; <a href="<? echo $ADMIN ?>?ADD=10000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Demuestre Los Teléfonos </a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=11111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Agregue Un Teléfono Nuevo </a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=12000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Teléfono Alias Lista </a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=12111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Añadir un nuevo teléfono Alias </a></TD></TR>
		<? }
	if (strlen($conference_sh) > 1) { 
		?>
	<TR BGCOLOR=<?=$conference_color ?>><TD ALIGN=LEFT COLSPAN=10><a href="<? echo $ADMIN ?>?ADD=1000000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Demuestre Las Conferencias </a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=1111111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Agregue Una Nueva Conferencia </a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=10000000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Demuestre Las Conferencias de VICIDIAL </a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=11111111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Agregue Una Nueva Conferencia de VICIDIAL </a></TD></TR>
		<? }
	if (strlen($server_sh) > 1) { 
		?>
	<TR BGCOLOR=<?=$server_color ?>><TD ALIGN=LEFT COLSPAN=10><a href="<? echo $ADMIN ?>?ADD=100000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Demuestre Los Servidores </a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=111111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Agregue Un Servidor Nuevo </a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=130000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Mostrar plantillas </a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=131111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Añadir una nueva plantilla </a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=140000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Show Transportistas </a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=141111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Add A New Carrier </a></TD></TR>
	<?}
	if (strlen($settings_sh) > 1) { 
		?>
	<TR BGCOLOR=<?=$settings_color ?>><TD ALIGN=LEFT COLSPAN=10><a href="<? echo $ADMIN ?>?ADD=311111111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Ajustes Del Sistema </a></TD></TR>
	<?}
	if (strlen($status_sh) > 1) { 
		?>
	<TR BGCOLOR=<?=$status_color ?>><TD ALIGN=LEFT COLSPAN=10><a href="<? echo $ADMIN ?>?ADD=321111111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>>Estados De Sistema</a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=331111111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>>Categorías Del Estado</a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=341111111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>>Códigos de estado de CC</a></TD></TR>
	<?}
...
<B><FONT FACE="ARIAL,HELVETICA" COLOR=white>ADMINISTRATION</FONT></B><BR>
	...
	<a href="<? echo $ADMIN ?>?ADD=0"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$users_fc ?> SIZE=<?=$header_font_size ?>><?=$users_bold ?>Usuarios</a>
	</TD></TR>
	<? if (strlen($users_hh) > 1) { 
		?>
	<TR BGCOLOR=<?=$users_color ?>><TD ALIGN=LEFT>
	 &nbsp; <a href="<? echo $ADMIN ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>>Mostrar Usuarios </a>
	</TR><TR BGCOLOR=<?=$users_color ?>><TD ALIGN=LEFT>
	 &nbsp; <a href="<? echo $ADMIN ?>?ADD=1"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>>Añadir un nuevo usuario </a>
	</TR><TR BGCOLOR=<?=$users_color ?>><TD ALIGN=LEFT>
	 &nbsp; <a href="<? echo $ADMIN ?>?ADD=1A"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>>Usuario Del Copiar</a>
	</TR><TR BGCOLOR=<?=$users_color ?>><TD ALIGN=LEFT>
	 &nbsp; <a href="<? echo $ADMIN ?>?ADD=550"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>>Búsqueda de un usuario </a>
	</TR><TR BGCOLOR=<?=$users_color ?>><TD ALIGN=LEFT>
	 &nbsp; <a href="./user_stats.php?user=<?=$user ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>>Estadísticas de usuario </a>
	</TR><TR BGCOLOR=<?=$users_color ?>><TD ALIGN=LEFT>
	 &nbsp; <a href="./user_status.php?user=<?=$user ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>>Condición de Usuario </a>
	</TR><TR BGCOLOR=<?=$users_color ?>><TD ALIGN=LEFT>
	 &nbsp; <a href="./AST_agent_time_sheet.php?agent=<?=$user ?>"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>>Hoja de tiempo </a> </TD></TR>
	<? } 
	?>
	<!-- CAMPAÑAS NAVIGATION -->
	<TR><TD <?=$campaigns_hh ?>>
	<a href="<? echo $ADMIN ?>?ADD=10"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$campaigns_fc ?> SIZE=<?=$header_font_size ?>><?=$campaigns_bold ?>Campañas</a>
	</TD></TR>
	<?
	if (strlen($campaigns_hh) > 1) 
		{ 
		...
		?>
		<TR BGCOLOR=<?=$campaigns_color ?>>
		<TD ALIGN=LEFT <?=$list_sh ?>> &nbsp; <a href="<? echo $ADMIN ?>?ADD=10"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$list_fc ?> SIZE=<?=$subcamp_font_size ?>>Principales Campañas</a></TD>
		</TR><TR BGCOLOR=<?=$campaigns_color ?>>
		<TD ALIGN=LEFT <?=$status_sh ?>> &nbsp; <a href="<? echo $ADMIN ?>?ADD=32"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$status_fc ?> SIZE=<?=$subcamp_font_size ?>>Estados</a></TD>
		</TR><TR BGCOLOR=<?=$campaigns_color ?>>
		<TD ALIGN=LEFT <?=$hotkey_sh ?>> &nbsp; <a href="<? echo $ADMIN ?>?ADD=33"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$hotkey_fc ?> SIZE=<?=$subcamp_font_size ?>>Teclas rápidas</a></TD>
		<?
		if ($SSoutbound_autodial_active > 0)
			{
			?>
			</TR><TR BGCOLOR=<?=$campaigns_color ?>>
			<TD ALIGN=LEFT <?=$recycle_sh ?>> &nbsp; <a href="<? echo $ADMIN ?>?ADD=35"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$recycle_fc ?> SIZE=<?=$subcamp_font_size ?>>Plomo Reciclado</a></TD>
			</TR><TR BGCOLOR=<?=$campaigns_color ?>>
			...
			<TD ALIGN=LEFT <?=$listmix_sh ?>> &nbsp; <a href="<? echo $ADMIN ?>?ADD=39"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$listmix_fc ?> SIZE=<?=$subcamp_font_size ?>>Mezcla lista</a></TD>
			<?
			}
		?>
		</TR><TR BGCOLOR=<?=$campaigns_color ?>>
		<TD ALIGN=LEFT <?=$pause_sh ?>> &nbsp; <a href="<? echo $ADMIN ?>?ADD=37"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$pause_fc ?> SIZE=<?=$subcamp_font_size ?>>Pausa Códigos</a></TD>
	<? } 
	?>
	<!-- LISTAS NAVIGATION -->
	<?
	if ($SSoutbound_autodial_active > 0)
		{
		?>
		<TR><TD ALIGN=LEFT <?=$lists_hh ?>><a href="<? echo $ADMIN ?>?ADD=100"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$lists_fc ?> SIZE=<?=$header_font_size ?>><?=$lists_bold ?>Listas</a></TD></TR>
		<?
		if (strlen($lists_hh) > 1) { 
			?>
		<TR BGCOLOR=<?=$lists_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=100"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Demuestre Las Listas </a>
		</TR><TR BGCOLOR=<?=$lists_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Agregue Una Nueva Lista </a>
		</TR><TR BGCOLOR=<?=$lists_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="admin_search_lead.php"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Búsqueda Para Un Plomo </a>
		</TR><TR BGCOLOR=<?=$lists_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=121"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Agregue El Número a DNC </a>
		</TR><TR BGCOLOR=<?=$lists_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="./new_listloader_superL.php"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Nuevos Plomos De la Carga </a>
		</TD></TR>
		<? } 
		}
	?>
	...
	<TR><TD <?=$scripts_hh ?>>
	<a href="<? echo $ADMIN ?>?ADD=1000000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$scripts_fc ?> SIZE=<?=$header_font_size ?>><?=$scripts_bold ?> Escrituras </a>
	</TD></TR>
	<?
	if (strlen($scripts_hh) > 1) 
		{ 
		...
		<a href="<? echo $ADMIN ?>?ADD=1000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Demuestre Las Escrituras </a>
		</TR><TR BGCOLOR=<?=$scripts_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=1111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Agregue Una Nueva Escritura </a>
		</TD></TR>
		<? } 
	?>
	<!-- FILTROS NAVIGATION -->
	...
	if ($SSoutbound_autodial_active > 0)
		{
		?>
		<TR><TD ALIGN=LEFT <?=$filters_hh ?>><a href="<? echo $ADMIN ?>?ADD=10000000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$filters_fc ?> SIZE=<?=$header_font_size ?>><?=$filters_bold ?> Filtros </a></TD></TR>
		<?
		if (strlen($filters_hh) > 1) 
			{ 
			?>
		<TR BGCOLOR=<?=$filters_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=10000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Demuestre Los Filtros </a>
		</TR><TR BGCOLOR=<?=$filters_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=11111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Agregue Un Filtro Nuevo </a>
		</TD></TR>
		<? } 
		}
	?>
	<!-- INGROUPS NAVIGATION -->
	<TR><TD <?=$ingroups_hh ?>>
	<a href="<? echo $ADMIN ?>?ADD=1000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$ingroups_fc ?> SIZE=<?=$header_font_size ?>><?=$ingroups_bold ?> En-Grupos </a>
	</TD></TR>
	<?
	if (strlen($ingroups_hh) > 1) 
		{ 
		...
		<a href="<? echo $ADMIN ?>?ADD=1000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Demuestre A En-Grupos </a>
		</TR><TR BGCOLOR=<?=$ingroups_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=1111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Agregue A Nuevo En-Grupo </a>
		</TR><TR BGCOLOR=<?=$ingroups_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=1211"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> En-Grupo Del Copiar</a>
		</TR><TR BGCOLOR=<?=$ingroups_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=1300"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Mostrar DIDs </a>
		</TR><TR BGCOLOR=<?=$ingroups_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=1311"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Añadir un nuevo DID </a>
		</TR><TR BGCOLOR=<?=$ingroups_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=1411"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> CopiarDID </a>
		</TD></TR>
		<? } 
		?>
	<!-- USERGROUPS NAVIGATION -->
	<TR><TD <?=$usergroups_hh ?>>
	<a href="<? echo $ADMIN ?>?ADD=100000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$usergroups_fc ?> SIZE=<?=$header_font_size ?>><?=$usergroups_bold ?> Grupos De Usuario </a>
	</TD></TR>
	<?
	if (strlen($usergroups_hh) > 1)
		{ 
		...
		<a href="<? echo $ADMIN ?>?ADD=100000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Demuestre A Grupos De Usuario </a>
		</TR><TR BGCOLOR=<?=$usergroups_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Agregue A Nuevo Grupo De Usuario </a>
		</TR><TR BGCOLOR=<?=$usergroups_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="group_hourly_stats.php"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Informe Cada hora Del Grupo </a>
		</TR><TR BGCOLOR=<?=$usergroups_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="user_group_bulk_change.php"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Basura Grupo Cambio </a>
		</TD></TR>
		<? } 
	?>
	<!-- REMOTEAGENTS NAVIGATION -->
	<TR><TD <?=$remoteagent_hh ?>>
	<a href="<? echo $ADMIN ?>?ADD=10000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$remoteagent_fc ?> SIZE=<?=$header_font_size ?>><?=$remoteagent_bold ?> Agentes Alejados </a>
	</TD></TR>
	<?
	if (strlen($remoteagent_hh) > 1) 
		{ 
		...
		<a href="<? echo $ADMIN ?>?ADD=10000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Demuestre Los Agentes Alejados </a>
		</TR><TR BGCOLOR=<?=$remoteagent_color ?>><TD ALIGN=LEFT> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=11111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Agregue Los Agentes Alejados Nuevos </a>
		</TD></TR>
	<? } 
	?>
	<!-- ADMIN NAVIGATION -->
	...
	if (strlen($admin_hh) > 1) 
		...
		<a href="<? echo $ADMIN ?>?ADD=100000000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$times_fc ?> SIZE=<?=$header_font_size ?>> Tiempos De la Llamada </a></TD>
		</TR><TR BGCOLOR=<?=$admin_color ?>><TD ALIGN=LEFT <?=$shifts_sh ?>> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=130000000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$shifts_fc ?> SIZE=<?=$header_font_size ?>> Turnos </a></TD>
		</TR><TR BGCOLOR=<?=$admin_color ?>><TD ALIGN=LEFT <?=$phones_sh ?>> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=10000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$phones_fc ?> SIZE=<?=$header_font_size ?>> Teléfonos </a></TD>
		</TR><TR BGCOLOR=<?=$admin_color ?>><TD ALIGN=LEFT <?=$templates_sh ?>> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=130000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$templates_fc ?> SIZE=<?=$header_font_size ?>> Plantillas </a></TD>
		</TR><TR BGCOLOR=<?=$admin_color ?>><TD ALIGN=LEFT <?=$carriers_sh ?>> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=140000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$carriers_fc ?> SIZE=<?=$header_font_size ?>> Transportistas </a></TD>
		</TR><TR BGCOLOR=<?=$admin_color ?>><TD ALIGN=LEFT <?=$server_sh ?>> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=100000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$server_fc ?> SIZE=<?=$header_font_size ?>> Servidores </a></TD>
		...
		<a href="<? echo $ADMIN ?>?ADD=311111111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$settings_fc ?> SIZE=<?=$header_font_size ?>> Ajustes Del Sistema </a></TD>
		</TR><TR BGCOLOR=<?=$admin_color ?>><TD ALIGN=LEFT <?=$status_sh ?>> &nbsp; 
		<a href="<? echo $ADMIN ?>?ADD=321111111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$status_fc ?> SIZE=<?=$header_font_size ?>>Estados De Sistema</a></TD>
		</TR>
		<? }
	?>
	<!-- INFORMES NAVIGATION -->
	<TR><TD <?=$reports_hh ?>>
	<a href="<? echo $ADMIN ?>?ADD=999999"><FONT FACE="ARIAL,HELVETICA" COLOR=<?=$reports_fc ?> SIZE=<?=$header_font_size ?>><?=$reports_bold ?> Informes </a>
	</TD></TR>
	</TABLE>
...
<TR BGCOLOR=#015B91>
	...
	if (strlen($shifts_sh) > 1) { 
		?>
	<TR BGCOLOR=<?=$shifts_color ?>><TD ALIGN=LEFT COLSPAN=2> &nbsp; <a href="<? echo $ADMIN ?>?ADD=130000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Mostrar cambios </a> &nbsp;| <a href="<? echo $ADMIN ?>?ADD=131111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Añadir un nuevo cambio </a></TD></TR>
		<? } 
	if (strlen($phones_sh) > 1) { 
		?>
	<TR BGCOLOR=<?=$phones_color ?>><TD ALIGN=LEFT COLSPAN=2> &nbsp; <a href="<? echo $ADMIN ?>?ADD=10000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Demuestre Los Teléfonos </a>&nbsp;|&nbsp;<a href="<? echo $ADMIN ?>?ADD=11111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Agregue Un Teléfono Nuevo </a>&nbsp;|&nbsp;<a href="<? echo $ADMIN ?>?ADD=12000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Teléfono Alias Lista </a>&nbsp;|&nbsp;<a href="<? echo $ADMIN ?>?ADD=12111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Añadir un nuevo teléfono Alias </a>&nbsp;|&nbsp;<a href="<? echo $ADMIN ?>?ADD=13000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Grupo Alias Lista </a>&nbsp;|&nbsp;<a href="<? echo $ADMIN ?>?ADD=13111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Añadir un nuevo grupo de alias </a></TD></TR>
		<? }
	if (strlen($conference_sh) > 1) { 
		?>
	...
	if ( (strlen($carriers_sh) > 1) and (strlen($admin_hh) > 1) ) { 
		?>
	<TR BGCOLOR=<?=$carriers_color ?>><TD ALIGN=LEFT COLSPAN=2> &nbsp; <a href="<? echo $ADMIN ?>?ADD=140000000000"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Show Transportistas </a> &nbsp; | &nbsp; <a href="<? echo $ADMIN ?>?ADD=141111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Add A New Carrier </a></TD></TR>
	<?}
	if (strlen($settings_sh) > 1) { 
		?>
	<TR BGCOLOR=<?=$settings_color ?>><TD ALIGN=LEFT COLSPAN=2> &nbsp; <a href="<? echo $ADMIN ?>?ADD=311111111111111"><FONT FACE="ARIAL,HELVETICA" COLOR=BLACK SIZE=<?=$subheader_font_size ?>> Ajustes Del Sistema </a></TD></TR>
	<?}
