...
$Aecho = '';
$Aecho .= "VF DIALER: Agents Time On Calls Campaña: $group                      $NOW_TIME\n\n";
$Aecho .= "+------------|--------+-----------------+----------------+-------+--------+-----------------+-----------------+---------+------------+\n";
...
#				{$G='<SPAN class="orange"><B>'; $EG='</B></SPAN>';}
		...
		$Aecho .= "  <SPAN class=\"yellow\"><B>          </SPAN> - Agentes detenidos brevemente</B>\n";
	#	$Aecho .= "  <SPAN class=\"orange\"><B>          </SPAN> - Balanced call</B>\n";
		...
		$Aecho .= "  <SPAN class=\"red\"><B>          </SPAN> - Sobre 10 minutos en llamada</B>\n";
