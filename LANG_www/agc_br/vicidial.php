		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//			var live_conf_HTML = "<font face=\"Arial,Helvetica\"><B>CHAMADAS ATIVAS NESTA CONFERÊNCIA:</B></font><BR><TABLE WIDTH=500><TR BGCOLOR=#E6E6E6><TD><font class=\"log_title\">#</TD><TD><font class=\"log_title\">CANAL REMOTO</TD><TD><font class=\"log_title\">DESLIGAR</TD><TD><font class=\"log_title\">TRANFERENCIA</TD></TR>";
							var live_conf_HTML = "<font face=\"Arial,Helvetica\"><B>LIGAÇÕES ATIVAS NA SUA SESSÃO:</B></font><BR><TABLE WIDTH=600><TR BGCOLOR=#E6E6E6><TD><font class=\"log_title\">#</TD><TD><font class=\"log_title\">CANAL REMOTO</TD><TD><font class=\"log_title\">DESLIGAR</TD><TD><font class=\"log_title\">VOLUME</TD></TR>";
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	alert(xmlhttp.responseText);
					...
					if (MDlookCID == "NO")
						{
						MD_ring_secondS++;
						document.getElementById("MainStatuSSpan").innerHTML = " Ligando: " + lead_dial_number + " UID: " + CIDcheck + " &nbsp; Aguardando Atender... " + MD_ring_secondS + " segundos";
				//		alert("channel not found yet:\n" + campaign);
						...
						if (taskCheckOR == 'YES')
							...
							if ( (MDchannel.match(regMDL)) && (asterisk_version != '1.0.8') && (asterisk_version != '1.0.9') )
								...
								MD_channel_look=0;
								document.getElementById("MainStatuSSpan").innerHTML = " Ligado: " + lead_dial_number + " UID: " + CIDcheck + " &nbsp;"; 
								...
								document.getElementById("InternalCloser").innerHTML = "<a href=\"#\" onclick=\"mainxfer_send_redirect('XfeRINTERNAL','" + lastcustchannel + "','" + lastcustserverip + "');return false;\"><IMG SRC=\"../agc/images/vdc_XB_internalcloser_ptbr.gif\" border=0 alt=\"CLOSER INTERNO\"></a>";
		...
		if (xmlhttp) 
			...
			//		alert(xmlhttp.responseText);
					...
					if (MDnextCID == " CHAMADA NOT PLACED")
						...
						document.getElementById("MainStatuSSpan").innerHTML = " Ligando: " + manDiaLonly_num + " UID: " + MDnextCID + " &nbsp; Aguardando Atender...";
...
// Send Hangup command for customer call connected to the conference now to Manager
	function dialedcall_send_hangup(dispowindow,hotkeysused,altdispo) 
		...
		//  DEACTIVATE CHANNEL-DEPENDANT BUTTONS AND VARIABLES
			...
			document.getElementById("InternalCloser").innerHTML = "<IMG SRC=\"../agc/images/vdc_XB_internalcloser_OFF_ptbr.gif\" border=0 alt=\"CLOSER INTERNO\">";
...
// GLOBAL FUNCTIONS
	...
	function conf_channels_detail(divvar) 
		...
		if (divvar == 'SHOW')
			...
			document.getElementById("busycallsdisplay").innerHTML = "<a href=\"#\"  onclick=\"conf_channels_detail('SHOW');\">Mostrar informações de discagem do canal</a>";
			document.getElementById("outboundcallsspan").innerHTML = '';
			LMAe[0]=''; LMAe[1]=''; LMAe[2]=''; LMAe[3]=''; LMAe[4]=''; LMAe[5]=''; 
			LMAcount=0;
			}
...
<span style="position:absolute;left:0px;top:0px;z-index:39;" id="NeWManuaLDiaLBox">
	...
	?>
	Nota: todos os novos contatos da discagem manual serão inseridos na lista 999<BR><BR>
	<table><tr>
...
<span style="position:absolute;left:5px;top:310px;z-index:21;" id="TransferMain">
	...
	<span STYLE="background-color: #CCCCCC" id="InternalCloser"><IMG SRC="../agc/images/vdc_XB_internalcloser_ptbr.gif" border=0 alt="CLOSER INTERNO"></span>
...
<span style="position:absolute;left:0px;top:0px;z-index:29;" id="AgenTDisablEBoX">
    <table border=1 bgcolor="#FFFFFF" width=770 height=500><TR><TD align=center>Sua sessão foi incapacitada<BR><a href="#" onclick="LogouT();return false;">SAIR</a><BR><BR><a href="#" onclick="hideDiv('AgenTDisablEBoX');return false;">Voltar</a>
</TD></TR></TABLE>
</span>
...
<span style="position:absolute;left:0px;top:0px;z-index:35;" id="CallBackSelectBox">
	...
	?>
	Comentarios do CB: <input type=text name="CallBackCommenTsField" size=50><BR><BR>
...
<tr><td align=left colspan=3>
<table><tr height=32><td height=32><font face="Arial,Helvetica" size=1>VICIDISCAR web-client version: <? echo $version ?> &nbsp; &nbsp; CONFIGURAÇÃO: <? echo $build ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Servidor: <? echo $server_ip ?>  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</font><BR>
<font class="body_small"><span id="busycallsdisplay"><a href="#"  onclick="conf_channels_detail('SHOW');">Mostrar informações de discagem do canal</a></span></font></td><td align=right height=32>
<? if ( ($HK_statuses_camp > 0) && ( ($user_level>=$HKuser_level) or ($VU_hotkeys_active > 0) ) ) { ?>
<span id="hotkeysdisplay"><a href="#" onMouseOver="HotKeys('ON')"><IMG SRC="../agc/images/vdc_XB_hotkeysactive_OFF_ptbr.gif" border=0 alt="ATALHOS DE STATUS INATIVOS"></a></span>
<? } ?>
</td></tr>
