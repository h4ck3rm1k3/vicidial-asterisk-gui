...
<table align=center width="500" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
  <tr>
	<td align=right width="25%"><font face="arial, helvetica" size=2>Last Leitungen von dieser Akte:</font></td>
  ...
  <tr>
	...
	<td align=center><input type=button onClick="javascript:document.location='listloader.php'" value="BEGINNEN SIE RÜBER" name='reload_page'></td>
  </tr>
  <tr><td colspan=2><font size=1><a href="new_listloader_superL.php" target="_parent">KLICKEN SIE HIER, UM ZUR SUPERLEITUNG LADEVORRICHTUNG ZU GEHEN (BETA VERSION)</a> &nbsp; &nbsp; <a href="admin.php" target="_parent">ZURÜCK ZU ADMIN</a></font></td></tr>
</table>
</form>
<?
