...
if ($ADD==71111)
{
	...
	echo "<FONT FACE=\"Courier\" COLOR=BLACK SIZE=2><PRE>";
	 ...
	 if ( (strlen($server_ip) < 2) or (strlen($user) < 2) )
		...
		echo "VICIDIAL: Στατιστικά εισερχομένων απομακρυσμένου χειριστή                               $NOW_TIME\n\n";
		echo "\n";
