...
echo "<TITLE>VICIDIAL: Time On VDAD Εκστρατεία: $group</TITLE></HEAD><BODY BGCOLOR=WHITE marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>\n";
...
$Aecho = '';
$Aecho .= "VICIDIAL: Agents Time On Calls Εκστρατεία: $group_string            $NOW_TIME\n";
