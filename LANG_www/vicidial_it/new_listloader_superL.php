...
<table align=center width="700" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
  ...
  <tr>
	...
	<td align=left width="75%"><font face="arial, helvetica" size=1><input type=text value="<?=$list_id_override ?>" name='list_id_override' size=10 maxlength=8> (solo cifre o lasciare in bianco per usare i valori contenuti nel file)</td>
  </tr>
  <tr>
	<td align=right width="25%"><font face="arial, helvetica" size=2>Sovrascrittura Codice Telefono: </font></td>
	<td align=left width="75%"><font face="arial, helvetica" size=1><input type=text value="<?=$phone_code_override ?>" name='phone_code_override' size=8 maxlength=6> (solo cifre o lasciare in bianco per usare i valori contenuti nel file)</td>
  </tr>
  <tr>
	<td align=right><B><font face="arial, helvetica" size=2>Struttura del file da usare:</font></B></td>
	<td align=left><font face="arial, helvetica" size=2><input type=radio name="file_layout" value="standard" checked>Standard VICIDIAL&nbsp;&nbsp;&nbsp;&nbsp;<input type=radio name="file_layout" value="custom">Struttura personalizzata</td>
  </tr>
    <tr>
...
<tr>
  ...
  <tr><td align=left><font size=1> &nbsp; &nbsp; &nbsp; &nbsp; <a href="admin.php?ADD=100" target="_parent">TORNA AD AMMINISTRAZIONE</a></font></td><td align=right><font size=1>LIST LOADER- &nbsp; &nbsp; VERSIONE: <?=$version ?> &nbsp; &nbsp; BUILD: <?=$build ?> &nbsp; &nbsp; </td></tr>
</table>
<? } ?>
