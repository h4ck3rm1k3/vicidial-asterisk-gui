...
<tr><td align=left><font face="Arial,Helvetica" size=1>VERSÃO astGUIclient do correia-cliente:<? echo $version ?> CONFIGURAÇÃO:<? echo $build ?></font></td></tr>
</TABLE>
...
<tr><td colspan=3>
<a href="#" onclick="pause();return false;">PAUSA</a> | <a href="#" onclick="start();return false;">COMEÇO</a> &nbsp; &nbsp; Refresque a taxa: <span id="refresh_rate">1000 ms</span> <a href="#" onclick="faster();return false;">Mais rapidamente</a> | <a href="#" onclick="slower();return false;">Mais lento</a></p>
