...
$ΥΠΟΒΑΛΛΩ=$_GET["ΥΠΟΒΑΛΛΩ"];				if (!$ΥΠΟΒΑΛΛΩ) {$ΥΠΟΒΑΛΛΩ=$_POST["ΥΠΟΒΑΛΛΩ"];}
...
echo "<TITLE>VF DIALER: Time On VDAD Εκστρατείας: $group</TITLE></HEAD><BODY BGCOLOR=WHITE>\n";
...
echo "</SELECT>\n";
echo "<INPUT type=submit NAME=ΥΠΟΒΑΛΛΩ Value=ΥΠΟΒΑΛΛΩ> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; \n";
...
$Aecho = '';
$Aecho .= "VF DIALER: Agents Time On Calls Εκστρατείας: $group                      $NOW_TIME\n\n";
$Aecho .= "+------------|--------+------------------+--------+-----------------+-----------------+---------+------------+\n";
...
#				{$G='<SPAN class="orange"><B>'; $EG='</B></SPAN>';}
		...
		$Aecho .= "  <SPAN class=\"yellow\"><B>          </SPAN> - Χρήστες σε παύση</B>\n";
